...
const notificationSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ['profile_submitted', 'job_posted', 'application_received', 'profile_approved', 'profile_rejected', 'interview_scheduled', 'interview_updated', 'profile_completion'], required: true },
